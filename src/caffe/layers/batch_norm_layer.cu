...
void BatchNormLayer<Dtype>::Forward_gpu(const vector<Blob<Dtype>*>& bottom,
  ...
  if (use_global_stats_) {
    ...
    kk_gpu_scale(variance_.count(), scale_factor,
        this->blobs_[0]->gpu_data(), mean_.mutable_gpu_data());
    // caffe_gpu_scale(variance_.count(), scale_factor,
    ...
    kk_gpu_gemv<Dtype>(bottom_data, spatial_sum_multiplier_.gpu_data(), num_by_chans_.mutable_gpu_data(), channels_ * num, spatial_dim, 1. / (num * spatial_dim), false);
    // caffe_gpu_gemv<Dtype>(CblasTrans, num, channels_, 1.,
    //     num_by_chans_.gpu_data(), batch_sum_multiplier_.gpu_data(), 0.,
    //     mean_.mutable_gpu_data());
    kk_gpu_gemv<Dtype>(num_by_chans_.gpu_data(), batch_sum_multiplier_.gpu_data(), mean_.mutable_gpu_data(), num, channels_, 1, true);
  }
  ...
  if (!use_global_stats_) {
    ...
    //     spatial_sum_multiplier_.gpu_data(), 0.,
    //     num_by_chans_.mutable_gpu_data());
    kk_gpu_gemv<Dtype>(temp_.gpu_data(), spatial_sum_multiplier_.gpu_data(), num_by_chans_.mutable_gpu_data(), channels_ * num, spatial_dim, 1. / (num * spatial_dim), false);
    ...
    kk_gpu_gemv<Dtype>(num_by_chans_.gpu_data(), batch_sum_multiplier_.gpu_data(), variance_.mutable_gpu_data(), num, channels_, Dtype(1.), true);
    ...
    kk_gpu_axpby(mean_.count(), Dtype(1), moving_average_fraction_, mean_.gpu_data(), this->blobs_[0]->mutable_gpu_data());
    ...
    kk_gpu_axpby(variance_.count(), bias_correction_factor, moving_average_fraction_, variance_.gpu_data(), this->blobs_[1]->mutable_gpu_data());
  }
...
//       num_by_chans_.mutable_gpu_data());
  kk_gpu_gemv<Dtype>(bottom_diff, spatial_sum_multiplier_.gpu_data(), num_by_chans_.mutable_gpu_data(), channels_ * num, spatial_dim, Dtype(1.), false);
//   caffe_gpu_gemv<Dtype>(CblasTrans, num, channels_, 1.,
//       num_by_chans_.gpu_data(), batch_sum_multiplier_.gpu_data(), 0.,
//       mean_.mutable_gpu_data());
  kk_gpu_gemv<Dtype>(num_by_chans_.gpu_data(), batch_sum_multiplier_.gpu_data(), mean_.mutable_gpu_data(), num, channels_, Dtype(1.), true);
...
//       num_by_chans_.mutable_gpu_data());
kk_gpu_gemv<Dtype>(top_diff, spatial_sum_multiplier_.gpu_data(), num_by_chans_.mutable_gpu_data(), channels_ * num, spatial_dim, Dtype(1.), false);
//   caffe_gpu_gemv<Dtype>(CblasTrans, num, channels_, 1.,
//       num_by_chans_.gpu_data(), batch_sum_multiplier_.gpu_data(), 0.,
//       mean_.mutable_gpu_data());
kk_gpu_gemv<Dtype>(num_by_chans_.gpu_data(), batch_sum_multiplier_.gpu_data(), mean_.mutable_gpu_data(), num, channels_, Dtype(1.), true);
